  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
        <i class="glyphicon glyphicon-check hidden-xs"></i> <span class="hidden-xs">กำลังดำเนินการ</span> 
        </h1>
      </section>
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="box-body">
					...
					$query = "SELECT *,orders.order_id as ooid, COUNT(orders.product_id) as coq,SUM(orders.quantity*products.product_price+products.shipping_charge) as qps FROM orders JOIN products ON products.id=orders.product_id WHERE orders.order_status!='$status' or orders.order_status is null GROUP BY orders.order_id ORDER BY orders.order_date " or die("Error:" . mysqli_error());
