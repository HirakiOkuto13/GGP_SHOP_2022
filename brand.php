  ...
  <?php include_once('header.php');?>
    ...
    <section class="ftco-section bg-light">
    	<div class="container">
            ...
            <h2 class="mb-4"><?php echo $bname ?></h2>
    	...
    	<div class="container">
    		...
    		<div class="row">
				...
				<?php 
                $select_product = mysqli_query($conn, "select * from products where brand = '$bname'") or die('Query Failed');
    				...
    				<div class="product d-flex flex-column">
    					...
    					<div class="text py-3 pb-4 px-3">
	    					...
	    					<p class="bottom-area d-flex px-3">
    							<a href="brand.php?page=product&action=add&id=<?php echo $fetch_product['id']; ?>" class="add-to-cart text-center py-2 mr-1"><span>Add to cart <i class="ion-ios-add ml-1"></i></span></a>
    							<a href="brand.php?page=product&action=goto&id=<?php echo $fetch_product['id']; ?>" class="buy-now text-center py-2">Buy now<span><i class="ion-ios-cart ml-1"></i></span></a>
    						</p>
    					</div>
    				</div>
    			</div>
